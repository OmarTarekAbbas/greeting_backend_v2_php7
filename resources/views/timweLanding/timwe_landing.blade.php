  ...
  <div class="main_container">
    <div class="landing_page">
      ...
      <div class="shbka">
        <div class="container">
          <!-- <h3>اشترك الان</h3> -->
          <h4 class="text-white font-weight-bold mt-2" style="font-size:22px;">قيمة الاشتراك 10 ريال / الاسبوع</h4>
          <div class="zain_viva">
        ...
        <div class="form_content">
          ...
          <form method="post" action="{{url('subscription/optin/'.partnerRoleId)}}" onsubmit="document.getElementById('zain_submit').disabled='true';" id="form_zain">
            ...
            <div class="form-group form-inline">
              ...
              <input type="tel" class="form-control" id="phone" required="" value="{{(session()->has('landing_msisdn')?session()->get('landing_msisdn'):'')}}" placeholder="أدخل رقم هاتفك الجوال" name="number" required pattern="[0-9]{8}">
