        ...
        <section class="third_slide w-100 mt-3">
          ...
          <div class="col-12 p-0">
            <div class="second_slide_title">
              <a href="{{url('/akhbar/'.$category->id.'/occasion/'.uid())}}">
              ...
              <div class="owl_two owl-carousel owl-theme" dir="ltr">
                ...
                <div class="owl_three owl-carousel owl-theme" dir="ltr">
                  ...
                  <div class="item">
                    ...
                    @if ($category->occasions()->get()->count() == 1)
                    <a class="owl_one_img w-100" href="{{url('/akhbar/'.$item->id.'/filter/'.uid())}}">
                      @elseif ($category->occasions()->get()->count() == 2)
                      <a class="owl_two_img w-100" href="{{url('/akhbar/'.$item->id.'/filter/'.uid())}}">
                        @elseif ($category->occasions()->get()->count() > 2)
                        <a class="owl_three_img w-100" href="{{url('/akhbar/'.$item->id.'/filter/'.uid())}}">
                          @endif
