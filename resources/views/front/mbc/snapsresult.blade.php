...
<a class="m-auto d-block" href="{{url('mbc/suboccasion/'.$snap->id.'/'.UID())}}">
  <div class="col-12 mb-3 swirl-out-bck_2">
    <div class="sub_img sub_img_small">
      <img class="w-75 m-auto d-block sub_img_smImg" src="{{url('assets/front/mbc')}}/images/new_cutting/strip1.png"
        alt="strip">
...
<div class="col-6">
  <div class="categories_page_bg shadow">
    <a href="{{url('mbc/filter/'.$snap->id.'/'.UID())}}">
