    ...
    <div class="containeer">
      <div class="row m-auto">
        ...
        <div class="col-12 mb-3 swirl-out-bck">
          <div class="sub_img">
            <img class="w-75 m-auto d-block" src="{{url('assets/front/mbc')}}/images/new_cutting/strip1.png" alt="strip">
        ...
        <div class="col-12 text-center m-auto">
          <div class="download_share">
            <a href="{{$Rdata->snap_link}}">
              <img class="w-50" src="{{url('assets/front/mbc')}}/images/new_cutting/shape1.png" alt="download">
        ...
        <div class="col-12 text-center m-auto">
          <div class="download_share">
            <a href="#" data-toggle="modal" data-target="#snapModal2">
              <img class="w-50" src="{{url('assets/front/mbc')}}/images/new_cutting/shape1.png" alt="Share">
