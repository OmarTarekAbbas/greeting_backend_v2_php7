...
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="dis">
                        <ul>
                            ...
                            {{-- <li>لإلغاء الإشتراك بإرسال رسالة نصية، لمشتركى اورنج: إرسال كلمة "stop snap chat" إلى الرقم المجانى 5030 ، لمشتركى اتصالات: إرسال "stop waffar" إلى الرقم المجانى 1722 ، لمشتركى شبكة فودافون: ارسال "stop waffar" إلى الرقم المجانى 6699</li>--}}
                            <li>لإلغاء الإشتراك بإرسال رسالة نصية، لمشتركى اورنج: إرسال كلمة "stop snap chat" إلى الرقم المجانى 5030 ، لمشتركى شبكة فودافون: ارسال "stop waffar" إلى الرقم المجانى 6699</li>
                            <p>او عن طريق هذا <a href="{{url('unsub')}}"> الرابط </a> </p>
                            <li>برجاء إرسال اى أسئلة أو شكاوى عن الخدمة إلى support@snapchat.com</li>
                        </ul>
                    </div>
    ...
    <div class="content">
        <center>
            <div class="container">
                <img class="logo" src="{{asset('landing_page/img')}}/Snapchat-logo.png" alt="">
                <h4 style='margin-top: -18px; color: #992d15;'>خدمة فلاتر</h4>
...
--}}
                        ...
                        <input type="submit" value="إشترك" class="btn" style=" background-color: #b8881d; color: white; width: 100px; font-size: 25px; margin-bottom: 0;" />
                        <p style="font-size: 13px !important; padding-top: 10px;">سعر الخدمة 2 جنيها يوميا</p>
                    ...
                    <div class="dis">
                        <ul>
                            <li>تكلفة الاشتراك لعملاء اورنج 2 جنية يوميا و لعملاء فودافون 2 جنيه يوميا</li>
                            <li>لإلغاء الإشتراك بإرسال رسالة نصية، لمشتركى اورنج: إرسال كلمة "stop snap chat" إلى الرقم المجانى 5030 ، لمشتركى شبكة فودافون: ارسال "stop snap chat" إلى الرقم المجانى 6699</li>
                            <p>او عن طريق هذا <a href="{{url('unsub')}}"> الرابط </a> </p>
                            <li>برجاء إرسال اى أسئلة أو شكاوى عن الخدمة إلى support@snapchat.com</li>
                        </ul>
                    </div>
