...
@section('content')
    ...
    @if(count($Rdata)>0)
        ...
        <div class="main">
            ...
            <div class="row" id="categoryStatus" action="inactive">
                <!-- =============================== -->
                @isset($child_occasions)
                    @foreach($child_occasions as $child)
                        <div class="col-xs-12 Rdata">
                            <div class="inner_category">
                                <a href="{{url('listSnap/'.$child->id.'/'.UID())}}"  class="main_inner snap_info">
                                    <img src="{{ url('assets/front/newdesign')}}/img/frame.png">
                                    <div class="title_photo_inner">
                                        <img src="{{  url($child->image) }}">

                                        <a  href="{{url('listSnap/'.$child->id.'/'.UID())}}" >
                                            <p  style="color:#000 !important;" >{{$child->title}}   </p>
                                        </a>
                ...
                @endforeach   {{--هنا علشان اعرض كلchild_occasions--}}
            @endisset
            <!-- =============================== -->
            </div>
