  ...
  <section class="filter_2day w-100 mt-3">
    <div class="container">
      <div class="row m-0">
        ...
        @if(isset($Rdata_today2))
        <div class="col-10 m-auto d-block">
          <div class="filter_2day_img mt-3">
            <a href="{{$Rdata_today2[0]->snap_link}}">
              <img class="w-100 d-block m-auto rounded rotate-scale-down" src="{{url('/'.$Rdata_today2[0]->path)}}" alt="Filter Today">

              <a class="first_list_img_heart" href="#0">
                <i class="fas fa-heart fa-lg ajax_call" value="{{$Rdata_today2[0]->id}}"></i>
              </a>
  ...
  <section class="filter_slide w-100 mt-3">
    <div class="col-12 p-0">
      <div class="second_slide_title">
        <a href="list.php">
          @if(isset($cat))
          <h6 class="text-right text-white pt-0 pr-3 scale-in-left">{{$cat->title}}
            ...
            <div class="modal-body">
                <div class="rounded-social-buttons w-100 text-center">
                    <a class="social-button facebook_link"
                        href="https://www.facebook.com/sharer/sharer.php?u={{url('rotanav2/inner/'.$Rdata_today2[0]->id.'/'.UID())}}" target="_blank"
                        title="Facebook">
                        <i class="fab fa-facebook-f facebook_icon"></i>
                    </a>

                    <a class="social-button whatsapp_link"
                        href="whatsapp://send?abid=+20111682831&text={{url('rotanav2/inner/'.$Rdata_today2[0]->id.'/'.UID())}}" title="Whatsapp">
                        <i class="fab fa-whatsapp whatsapp_icon"></i>
                    </a>

                    <a class="social-button twitter_link" href="http://twitter.com/share?url={{url('rotanav2/inner/'.$Rdata_today2[0]->id.'/'.UID())}}"
