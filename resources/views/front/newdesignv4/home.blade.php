        ...
        <div class="item">
            <a href="#">
                ...
                <a href="{{$snap->snap_link}}" class="user_filter">
                    <h4 class=" use_filter_link text-center p-1">Fîlter bikar bînin
</h4>
        ...
        <div class="contant rounded" style="padding: 5px 20px;">
            <div class="row">
                <div class="filter_today1 col-8" style="margin-top: -9%;">
                    ...
                    <i id="{{$Rdata_today[0]->id}}" @if(check_favourtite(\Session::get('MSISDN') , $Rdata_today[0]->id))
                        class="far fa-heart heart active"
                        @else class="far fa-heart heart" @endif></i>
                    @endif

                    <a href="{{url('newdesignv4/filter/'.$Rdata_today[0]->id.'/'.UID())}}">

                        <div class="filter-img">
                            <img class="img-fluid" src="{{url('/'.$Rdata_today[0]->path)}}" alt="today filter"
                                style="margin-top: 13%">
                ...
                <div class="col-4">
                    <div class="filter-title">
                        <h3 class="text-center">{{$Rdata_today[0]->getTranslation('title',getCode())}}</span></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="contant rounded">
                    @if(count($sliders) < 2) <div class="owl-one owl-carousel owl-theme">
                            ...
                            <div class="owl-three owl-carousel owl-theme">
                                ...
                                <div class="item m-1">
                                    ...
                                    <i id="{{$suggest->id}}" @if(check_favourtite(\Session::get('MSISDN') , $suggest->id)) class="far fa-heart heart active"
                                        @else class="far fa-heart heart" @endif></i>
                                    @endif
                                    <a href="{{url('newdesignv4/suboccasion/'.$suggest->id.'/'.UID())}}">
                                ...
                                <div class="item m-1">
                                    @if(\Session::has('MSISDN') && \Session::get('Status') == 'active' )
                                    <i id="{{$occasion->id}}" @if(check_favourtite(\Session::get('MSISDN') , $occasion->id)) class="far fa-heart heart active"
                                        @else class="far fa-heart heart" @endif></i>
                                    @endif
                                    <a href="{{url('newdesignv4/suboccasion/'.$occasion->id.'/'.UID())}}">
                                        <img class="rounded d-block m-auto" height="83" src="{{url('/'.$occasion->image)}}" alt="{{$occasion->getTranslation('title',getCode())}}">
                                    </a>
                                </div>
                                @endforeach
                            </div>
                            ...
                            @if(count($Rdata_today2) < 2) <div class="owl-one owl-carousel owl-theme">
                                ...
                                <div class="owl-two owl-carousel owl-theme">
                                    ...
                                    <div class="owl-three owl-carousel owl-theme">
                                        ...
                                        <div class="item m-1">
                                            @if(\Session::has('MSISDN') && \Session::get('Status') == 'active' )
                                            <i id="{{$fav->id}}" @if(check_favourtite(\Session::get('MSISDN') ,
                                                $fav->id)) class="far fa-heart heart active"
                                                @else class="far fa-heart heart" @endif></i>
                                            @endif

                                            <a href="{{url('newdesignv4/filter/'.$fav->id.'/'.UID())}}">
                                                <img class="rounded d-block m-auto" src="{{url('/'.$fav->path)}}" alt=""
                                                    height="83">
