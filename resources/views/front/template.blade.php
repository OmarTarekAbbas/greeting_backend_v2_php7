...
<!--                @if($count['Snap'] >= 1)
                ...
                @endif
                @if($count['Rbt'] >= 1)
                <li><a href="{{url('rbts/'.UID())}}"><i class="fa fa-headphones"></i>كول تون</a></li>
                @endif
                @if($count['Not'] >= 1)
                <li><a href="{{url('notifications/'.UID())}}"><i class="fa fa-bell"></i>نغمات اشعار</a></li>
                @endif
                @if($count['Imgs'] >= 1)
                <li><a href="{{url('imgs/'.UID())}}"><i class="fa fa-picture-o"></i>الصور</a></li>
                @endif
                @if($count['Vid'] >= 1)
                <li><a href="{{url('vids/'.UID())}}"><i class="fa fa-file-video-o"></i>الفيديوهات</a></li>
                @endif-->


<!--             <li><a href="{{url('snap/'.UID())}}"><i class="far fa-image"></i>Snap</a></li>

                <li><a href="{{url('rbts/'.UID())}}"><i class="far fa-headphones"></i>كول تون</a></li>-->

<!--                <li><a href="{{url('notifications/'.UID())}}"><i class="far fa-bell"></i>نغمات اشعار</a></li>-->

<!--                <li><a href="{{url('imgs/'.UID())}}"><i class="far fa-image"></i>الصور</a></li>

                <li><a href="{{url('vids/'.UID())}}"><i class="far fa-file-video"></i>الفيديوهات</a></li>-->


<li><a href="{{url('snap/'.UID())}}"><i class="far fa-home fa-lg"></i><p>الرئيسة</p></a></li>
