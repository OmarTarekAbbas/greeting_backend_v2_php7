  ...
  <div class="main_container">
    <div class="landing_page">
      ...
      <div class="strip">
        ...
        @if ($lang == 'ar')
        <a href="{{url("du_landing_dcb2/lang/en")}}" class="mb-0" style="color: #fff;">
          اللغة الانجليزية
        </a>
        @else
        <a href="{{url("du_landing_dcb2/lang/ar")}}" class="mb-0" style="color: #fff;">
          اللغة العربية
        </a>
        @endif
      </div>
      ...
      <div class="container">
        <div class="form_content">
          <form method="post" action="{{url('DuDcbRedirect')}}" onsubmit="document.getElementById('zain_submit').disabled='true';" id="form_zain">
            {{ csrf_field() }}
