    ...
    <div class="landing_page">
        ...
        <div class="shbka">
            <div class="container">
                ...
                @if ($lang == 'ar')
                    <h5><a href="{{url('/'.'du_landing/daily/en')}}">اللغة الانجليزيه</a></h5>
                @elseif($lang == 'en')
                  <h5><a href="{{url('/'.'du_landing/daily')}}">اللغة العربيه</a></h5>
                @else()
                 <h5><a href="{{url('/'.'du_landing/daily')}}">اللغة العربيه</a></h5>
                @endif
                <div class="zain_viva">
        ...
        <div class="container">
            <div class="form_content">
                <form method="get" action="{{url('DuSecureRedirect')}}"
        ...
        @if ($lang == 'ar')
            <div class="cancel">
                <p style="color: #5f4f4f">لالغاء الاشتراك يرجي الضغط علي هذا <a
                            href="{{url('du_unsubc'."/".$peroid."/".$lang )}}">الرابط</a></p>
            </div>
        @else
            <div class="cancel">
...
<div class="the-frame">
    <iframe class="full-screen-preview__frame" src="{{url()->full()}}" name="preview-frame" frameborder="0"
            noresize="noresize" data-view="fullScreenPreview" style="height: 570px; width: 370px; border-radius: 10px;">
    </iframe>
</div>
