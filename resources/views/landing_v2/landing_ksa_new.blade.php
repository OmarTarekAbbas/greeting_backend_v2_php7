            ...
            <div class="row justify-content-center m-0">
              <div class="col-6 p-0">
                <a class="operator" sms='798940' body='1' href="">
                  <img class="img-fluid w-75" src="{{ url('assets/front/landing_v2')}}/img/snap_new_landing/landing_ksa/zain.png" id="zain1">
                </a>
              </div>
              ...
              <div class="col-6 p-0">
                <a class="operator" sms='604090' body='78' href="">
                  <img class="img-fluid w-75" src="{{ url('assets/front/landing_v2')}}/img/snap_new_landing/landing_ksa/Mobily.png" id="mobily">
                </a>
              </div>
            </div>
          </div>
