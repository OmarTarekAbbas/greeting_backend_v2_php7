            ...
            <div class="row justify-content-center ml-0">
              <div class="col-12">
                <a class="operator" sms='4350' body='1' href="">
                  <img class="img-fluid w-50" src="{{ url('assets/front/landing_v2')}}/img/snap_new_landing/landing_iraq/zain.png" id="zain1">
                </a>
              </div>

              <!-- <div class="col-4 pl-0">
                <a class="operator" sms='4350' body='1' href="">
                  <img class="img-fluid w-100" src="{{ url('assets/front/landing_v2')}}/img/snap_new_landing/landing_iraq/korek.png" id="zain1">
                </a>
              </div>

              <div class="col-4 pl-0">
                <a class="operator" sms='4350' body='1' href="">
                  <img class="img-fluid w-100" src="{{ url('assets/front/landing_v2')}}/img/snap_new_landing/landing_iraq/Asia_cell.png" id="zain1">
                </a>
              </div>

              <div class="col-4 pl-0">
                <a class="operator" sms='4350' body='1' href="">
                  <img class="img-fluid w-100" src="{{ url('assets/front/landing_v2')}}/img/snap_new_landing/landing_iraq/zain.png" id="zain1">
                </a>
              </div> -->
              <br>
            </div>
