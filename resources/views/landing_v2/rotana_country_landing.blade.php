        ...
        <div class="row">
          ...
          <div class="col-4">
            <a href="sms:606068{{$Att}}37" class="click_op" data-country = "{{$country}}" data-operator="Mobily">
              <img src="{{ url('assets/front/landing_v2')}}/operators2/MOBILE.png" alt="">
              <p>Mobily</p>
            </a>
          ...
          <div class="col-4">
            <a href="sms:798940{{$Att}}10" class="click_op" data-country = "{{$country}}" data-operator="Zain">
              <img src="{{ url('assets/front/landing_v2')}}/operators2/ZAIN_KSA.png" alt="">
              <p>Zain</p>
            </a>
          ...
          <div class="col-4">
            <a href="sms:801267{{$Att}}6" class="click_op" data-country = "{{$country}}" data-operator="STC">
              <img src="{{ url('assets/front/landing_v2')}}/operators2/STC.png" alt="">
              <p>STC</p>
            </a>
          ...
          <div class="col-6">
            <a href="sms:9999{{$Att}}10083" class="click_op" data-country = "{{$country}}" data-operator="Vodafone">
              <img src="{{ url('assets/front/landing_v2')}}/operators2/VODAFONE.png" alt="">
              <p>Vodafone</p>
            </a>
          ...
          <div class="col-6">
            <a href="sms:90355{{$Att}}1" class="click_op" data-country = "{{$country}}" data-operator="Zain">
              <img src="{{ url('assets/front/landing_v2')}}/operators2/ZAIN_KW.png" alt="">
              <p>Zain </p>
            </a>
