...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-JH5PV7CS62"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-JH5PV7CS62');
  </script>
  <meta charset="utf-8">
    ...
    <div class="landing_page">
      ...
      <div class="container">
        <ul class="terms text-right text-white rounded" dir="rtl">
          <li> سعر الخدمة 1.15 ريال يوميا (شامل قيمة الضريبة المضافة)</li>
