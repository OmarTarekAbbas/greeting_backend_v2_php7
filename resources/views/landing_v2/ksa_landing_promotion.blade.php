    ...
    <div class="landing_page">
          ...
          <div class="zain_viva">
            ...
            <div class="row justify-content-center">
              <div class="col-4 card">
                <a href="javascript:void(0);" class="service" data-service="mobily">
                  <img src="{{ url('assets/front/landing_v2')}}/img/mobily.png" style="height: 10em; margin-top: -1em;" class="card-img-top" alt="...">
                </a>
              </div>
              <div class="col-4 card">
                <a href="javascript:void(0);" class="service" data-service="zain">
                  <img src="{{ url('assets/front/landing_v2')}}/operators2/ZAIN_KSA.png" style="height: 6em; margin-top: 1em;" class="card-img-top" alt="...">
                </a>
              </div>
              <div class="col-4 card">
                <a href="javascript:void(0);" class="service" data-service="falatr">
      ...
      <div class="container">
        <div class="form_content">
          ...
          <div class="cancel">
            <p>اشترك في الخدمة مقابل 1.15 ريال يوميا </p>
          </div>
        </div>
      </div>
    </div>
