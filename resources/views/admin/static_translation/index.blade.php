		...
		<div class="col-md-12">
			<div class="box box-black">
				...
				<div class="btn-toolbar pull-right">
                        <div class="btn-group">
                            <a class="btn btn-circle show-tooltip" title="" href="{{url('admin/static_translation/create')}}" data-original-title="Add new record"><i class="fa fa-plus"></i></a>
                            <?php
							...
							@foreach($static_translations as $static_translation)
								...
								<th><input class="select_all_template" type="checkbox" name="selected_rows[]" value="{{$static_translation->id}}" class="roles" onclick="collect_selected(this)"></th>
									...
									<td>
										...
										@else
											<a href="{{url('admin/static_translation/'.$static_translation->id)}}" title="View Translation">View Translation</a>
										@endif
									</td>
									<td class="visible-md visible-lg">
										<div class="btn-group">
											<a class="btn btn-sm show-tooltip" title="" href="{{url('admin/static_translation/'.$static_translation->id.'/edit')}}" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                            {!! Form::open(array('class' => 'form-inline col-lg-1','method' => 'DELETE', 'action' => array('StaticTranslationController@destroy', $static_translation->id))) !!}
