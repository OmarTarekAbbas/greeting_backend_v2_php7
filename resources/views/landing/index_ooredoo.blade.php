@extends('landing.template_ooredoo')
@section('section')
...
<div class="landing_page">
  ...
  <div class="shbka">
    <div class="container">
      ...
      <div class="zain_viva">
        ...
        <div class="row">
          <!--                    <div class="col-4">
                         <img   src="{{ url('assets/front/landing')}}/img/viva.webp"  onclick="vivaSub()" id="viva">
  ...
  <div class="container">
    <div class="form_content" id="ooredoo_kuwait_form">
      <h5>ادخل رقم الهاتف</h5>
      <form class="form" id=ooredoo_kuwait method="post" action="subscribeOreedo" style="top: 75% ">
        {{ csrf_field() }}
        <div class="form-group form-inline">
          <label for="phone">965</label>
          <input type="hidden" name="prev_url" value="{{(isset($_REQUEST['prev_url'])?$_REQUEST['prev_url']:'')}}">
          <input id="ooredoo_number" type="text" class="form-control" value="{{$MSISDN}}" id="phone" placeholder="000-000-00" name="number" required pattern="[0-9]{8}">
          <span class="validity"></span>
        </div>
        <button class="btn" type="submit">اشترك</button>
      </form>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#ooredoo_kuwait_form').css('display', 'block');
    var msisdn = $("#ooredoo_number").val();
    if (msisdn != "") {
      $('#ooredoo_kuwait').submit()
    }
  });
</script>
