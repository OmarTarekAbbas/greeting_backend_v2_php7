...
class StaticTranslationController extends Controller
{
    ...
    public function index()
    {
        ...
        //return $languages;
        return view('admin.static_translation.index',compact('static_translations','languages'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.static_translation.create',compact('languages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/static_translation');
    }
    ...
    public function show($id)
    {
        ...
        $languages = Language::all();
        return view('admin.static_translation.view',compact('languages','static_translation'));
    }
    ...
    public function edit($id)
    {
        $static_translation = StaticTranslation::find($id);
        $languages = Language::all();
        return view('admin.static_translation.create',compact('languages','static_translation'));
    }
