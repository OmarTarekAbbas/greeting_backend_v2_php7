                            ...
                            <?php if(count($GreetingImgs) > 0): ?>
                                <?php $__currentLoopData = $GreetingImgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $GreetingImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($GreetingImg->popular_count); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\php7.2\xampp\htdocs\greeting_backend_v2_php7\resources\views/admin/ordersnap/index.blade.php ENDPATH**/ ?>