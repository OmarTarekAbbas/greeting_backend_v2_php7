...
<div class="main">
    ...
    <div class="owl_main owl-carousel owl-theme">
        ...
        <div class="item">
            <a href="<?php echo e(url('listSnap/'.$slider->id.'/'.UID())); ?>">
    ...
    <div class="container">
        ...
        <div class="search">
            ...
            <form  action="<?php echo e(url('Search_v3/'.UID())); ?>" method="get">
                  ...
                  <div class="row">
                      ...
                      <div class="col-4 p-0">
                          <div class="poster_filtar">
                            ...
                            <?php endif; ?>
                              <a href="<?php echo e(url('viewSnap2/'.$Rdata_today[0]->id.'/'.UID())); ?>">
    ...
    <!-- Suggestion -->
    <div class="filtars">
        <div class="f_title" style="color:black">
              ...
              <?php $__currentLoopData = $suggests->take(10)->shuffle(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suggest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                  ...
                  <div class="view">
                    ...
                    <a href="<?php echo e(url('viewSnap2/'.$suggest->id.'/'.UID())); ?>">
              ...
              <?php $__currentLoopData = $populars->take(10)->shuffle(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popular): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                  ...
                  <div class="view">
                    ...
                    <a href="<?php echo e(url('viewSnap2/'.$popular->id.'/'.UID())); ?>">
              ...
              <?php $__currentLoopData = $favourites->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fav): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                  ...
                  <div class="view">
                    ...
                    <a href="<?php echo e(url('viewSnap2/'.$fav->id.'/'.UID())); ?>">
...
<?php echo $__env->make('front.newdesign.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\php7.2\xampp\htdocs\greeting_backend_v2_php7\resources\views/front/newdesign/home.blade.php ENDPATH**/ ?>