...
<div class="main">
        ...
        <div class="contant rounded" style="padding: 5px 20px;">
            <div class="row">
                <div class="filter_today1 col-8" style="margin-top: -9%;">
                    ...
                    <i id="<?php echo e($Rdata_today[0]->id); ?>" <?php if(check_favourtite(\Session::get('MSISDN') , $Rdata_today[0]->id)): ?> class="far fa-heart heart active"
                        <?php else: ?> class="far fa-heart heart" <?php endif; ?>></i>
                    <?php endif; ?>

                    <a href="<?php echo e(url('rotana/filter/'.$Rdata_today[0]->id.'/'.UID())); ?>">

                        <div class="filter-img">
                            <img class="img-fluid" src="<?php echo e(url('/'.$Rdata_today[0]->path)); ?>" alt="today filter" style="margin-top: 13%">
                ...
                <div class="col-4">
                    ...
                    <h3 class="text-center h5" style="color:#347742"><?php echo e($Rdata_today[0]->getTranslation('title',getCode())); ?></span></h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="status">
        <div class="row">
                            ...
                            <div class="owl-three owl-carousel owl-theme">
                                ...
                                <div class="item m-1">
                                    ...
                                    <i id="<?php echo e($suggest->id); ?>" <?php if(check_favourtite(\Session::get('MSISDN') , $suggest->id)): ?> class="far fa-heart heart active"
                                        <?php else: ?> class="far fa-heart heart" <?php endif; ?>></i>
                                    <?php endif; ?>
                                    <a href="<?php echo e(url('rotana/suboccasion/'.$suggest->id.'/'.UID())); ?>">
                                        ...
                                        <!-- <h4 class="h6 text-center" style="color:#495057"><?php echo e($suggest->getTranslation('title',getCode())); ?></h4> -->
                                    </a>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            ...
                            <?php if(count($Rdata_today2) < 2): ?> <div class="owl-one owl-carousel owl-theme">
                                ...
                                <div class="owl-two owl-carousel owl-theme">
                                    ...
                                    <div class="owl-three owl-carousel owl-theme">
                                        ...
                                        <div class="item m-1">
                                            <?php if(\Session::has('MSISDN') && \Session::get('Status') == 'active' ): ?>
                                            <i id="<?php echo e($fav->id); ?>" <?php if(check_favourtite(\Session::get('MSISDN') , $fav->id)): ?> class="far fa-heart heart active"
                                                <?php else: ?> class="far fa-heart heart" <?php endif; ?>></i>
                                            <?php endif; ?>

                                            <a href="<?php echo e(url('rotana/filter/'.$fav->id.'/'.UID())); ?>">
                                                <img class="rounded d-block m-auto" src="<?php echo e(url('/'.$fav->path)); ?>" alt="" height="83">
            ...
            <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.rotana.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\greeting_backend_v2_php7\resources\views/front/rotana/home.blade.php ENDPATH**/ ?>