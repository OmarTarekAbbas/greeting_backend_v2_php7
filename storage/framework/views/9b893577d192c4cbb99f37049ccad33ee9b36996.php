...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(count($Rdata)>0): ?>
        ...
        <div class="main">
            ...
            <div class="row" id="categoryStatus" action="inactive">
                <!-- =============================== -->
                <?php if(isset($child_occasions)): ?>
                    <?php $__currentLoopData = $child_occasions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xs-12 Rdata">
                            <div class="inner_category">
                                <a href="<?php echo e(url('listSnap/'.$child->id.'/'.UID())); ?>"  class="main_inner snap_info">
                                    <img src="<?php echo e(url('assets/front/newdesign')); ?>/img/frame.png">
                                    <div class="title_photo_inner">
                                        <img src="<?php echo e(url($child->image)); ?>">

                                        <a  href="<?php echo e(url('listSnap/'.$child->id.'/'.UID())); ?>" >
                                            <p  style="color:#000 !important;" ><?php echo e($child->title); ?>   </p>
                                        </a>
