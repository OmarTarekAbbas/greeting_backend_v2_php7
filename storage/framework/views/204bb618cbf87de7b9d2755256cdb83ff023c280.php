                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="text text-info">link 4 : </span>  <input class="" value='<?php echo e(url("newdesignv4/$URL->UID")); ?>'/>
                                <button class="btn btn-info btn-xs copy" data-toggle="tooltip" data-placement="top" title="Copy to clipboard"><i class="fa fa-copy"></i></button>
                                <div style="display:none"><?php echo e(url("newdesignv4/$URL->UID")); ?></div>
                                <br/>
                                <span class="text text-info">rotana: </span>  <input class="" value='<?php echo e(url("rotana/$URL->UID")); ?>'/>
                                <button class="btn btn-info btn-xs copy" data-toggle="tooltip" data-placement="top" title="Copy to clipboard"><i class="fa fa-copy"></i></button>
                                <div style="display:none"><?php echo e(url("rotana/$URL->UID")); ?></div>
                            <?php else: ?>
