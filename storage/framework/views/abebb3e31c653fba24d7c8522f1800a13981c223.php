...
<ul class="sounds snapchat check list-unstyled">
        ...
        <?php $__currentLoopData = $Snapdata[$oc_id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- Audio -->
        <li data-type="<?= $img->rbt_id ? 1 : 0 ?>" class="snap occasion_<?php echo e($img->occasion_id); ?> <?php if(Occasion()!= $img->occasion_id ): ?> sound_hide <?php endif; ?>" >
            <!--        <?php if($img->rbt_id): ?>
            ...
            <?php if($img->rbt_id): ?>
            <a class="icon"  href="sms:<?php echo e($rbt_sms); ?><?php echo $Att; ?><?php echo e($codes[0][$key]); ?>"><i class="fas fa-cart-plus"></i></a>
            ...
            <?php endif; ?>
             ...
             <div class="view">
                    <i id="eye" class="fas fa-eye"></i> <span> <?php echo e($img->popular_count); ?></span>
                  </div>
    ...
    $(window).on("scroll", function () {
      ...
      if(typeof action == "undefined")
        var action = $('#chooseimageitem .active1 .item').attr('action');
            ...
            var occasion_id = '<?php echo e($Snapdata[$oc_id][0]->occasion_id); ?>';
...
<?php echo $__env->make('front.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\greeting_backend_v2_php7\resources\views/front/snap.blade.php ENDPATH**/ ?>