        ...
        <?php $__env->startSection('script'); ?>
                ...
                <script>
                    ...
                    function load_snap_data(start) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: "<?php echo e(url('loadMoreSnapNew')); ?>" + "?start=" + start + "&search=" + search_key + "&UID=" + <?php echo e(UID()); ?>,
...
<?php echo $__env->make('front.newdesign.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\php7.2\xampp\htdocs\greeting_backend_v2_php7\resources\views/front/newdesign/search.blade.php ENDPATH**/ ?>