...
<!--                            <p>  مرحبا   <span> <?php echo e(Session::get('MSISDN')); ?></span></p>-->
                        ...
                        <?php endif; ?>
                        <li>
                            <a href="<?php echo e(url('link2/snapCategory/'.UID())); ?>">
                       ...
                       <li>
                          ...
                          <li><a href="<?php echo e(url('logout_viva/'.UID())); ?>"><i style="font-size: 21px;"  class="fas fa-sign-out-alt"></i> خروج</a></li>
                          <?php endif; ?>
                       <?php endif; ?>
...
<?php /**PATH E:\php7.2\xampp\htdocs\greeting_backend_v2_php7\resources\views/front/newdesign/template.blade.php ENDPATH**/ ?>